...
namespace Lima.OverTheShoulder
{
  ...
  public class CamOTS
  {
    ...
    {
      if ((!Config.KeyBind && !MyAPIGateway.Input.IsAnyAltKeyPressed()) || MyAPIGateway.Gui.IsCursorVisible || MyAPIGateway.Gui.ChatEntryVisible || MyAPIGateway.Input.IsAnyCtrlKeyPressed())
        return;
